...
import { Row, Col, Image, ListGroup, Button, Card, Form, ButtonGroup } from "react-bootstrap";
...
function ProductScreen({ match, history }) {
  ...
  const { products, loadingP, errorP, page, pages } = productList;
  ...
  const addToCartHandler = () => {
    if (selectedSize) {
      ...
      dispatch(addToCart(match.params.id, qty, selectedSize));
    } else {
